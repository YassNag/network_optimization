...
function resolution_modele(instance)
    ...
    relaxed=false
    temp_creation_modele = @elapsed modele = creation_modele(instance, E1, E2, E4, ajout_R1, ajout_R2, ajout_R3, ajout_R4, ajout_R5, relaxed)
    ...
    relaxed=true
    relaxed_modele = creation_modele(instance, E1, E2, E4, ajout_R1, ajout_R2, ajout_R3, ajout_R4,ajout_R5, relaxed)
...
function creation_modele(instance, E1, E2, E4, ajout_R1, ajout_R2, ajout_R3, ajout_R4, ajout_R5, relaxed)
